...
const log = data => console.log('delayedGreet')
...
const log2 = data => console.log('good bye')
...
/* CHALLENGE 5 */
const logHi = data => console.log('hi again')
...
function everyXsecsForYsecs(method, interval, duration) {
  // ADD CODE HERE
  const id = setInterval(method, interval*1000)
